...
def stats_for(ticker):
    ...
    print("- Yield on cost:")
    print("- 5Y average FFOPS: {0}".format(str(Money(finance.average_ffops('reits', ticker), currency))))
    print("- 5Y average FFOPS growth rate: {0}%".format(finance.average_ffops_growth('reits', ticker)))
    print("- Beta:")
    print("- Dilution:")
