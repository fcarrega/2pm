...
def stats_for(ticker):
    ...
    print("- Debt to market value: {0:.2f}%".format(finance.debt_to_market_value('reits', ticker, 'quarterly')))
    print("- Payout ratio: {0:.2f}%".format(finance.payout_ratio('reits', ticker)))
    # print("- Yield on cost:")
